...
agent = TeamAgent("/root/autodl-fs/model/Llama-3.2-11B-Vision-Instruct",
                    local_model_path="/root/autodl-fs/model", local_data_path="/root/autodl-fs/data"
                    )
...
print(agent.generate_response(**test_sample))